...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('status', sa.Enum('active', 'completed', 'paused', 'abandoned'), nullable=False),
        sa.Column('current_difficulty', sa.Enum('beginner', 'elementary', 'intermediate', 'advanced', 'expert'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('difficulty_level', sa.Enum('beginner', 'elementary', 'intermediate', 'advanced', 'expert'), nullable=False),
        sa.Column('mastery_level', sa.Enum('not_started', 'learning', 'practicing', 'mastered', 'needs_review'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('locked', 'unlocked', 'in_progress', 'completed'), nullable=False),
        sa.Column('target_date', sa.Date(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('priority', sa.Enum('low', 'medium', 'high', 'critical'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('learning_path_id', sa.Integer(), nullable=True),
        sa.Column('current_difficulty', sa.Enum('beginner', 'elementary', 'intermediate', 'advanced', 'expert'), nullable=False),
        sa.Column('previous_difficulty', sa.Enum('beginner', 'elementary', 'intermediate', 'advanced', 'expert'), nullable=True),
        sa.Column('recommended_difficulty', sa.Enum('beginner', 'elementary', 'intermediate', 'advanced', 'expert'), nullable=False),
