...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('institution_id', sa.Integer(), nullable=False),
        sa.Column('report_type', sa.Enum('STUDENT_PERFORMANCE', 'CLASS_PERFORMANCE', 'INSTITUTION_PERFORMANCE', 
                                         'ATTENDANCE_SUMMARY', 'ASSIGNMENT_SUMMARY', 'EXAM_ANALYSIS', 
                                         'YOY_COMPARISON', 'SUBJECT_ANALYSIS', name='reporttype'), nullable=False),
        ...
        sa.Column('status', sa.Enum('PENDING', 'PROCESSING', 'COMPLETED', 'FAILED', name='reportstatus'), 
