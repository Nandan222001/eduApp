...
def upgrade() -> None:
    ...
    permissions_data = [
        {'id': 1, 'name': 'View Users', 'slug': 'users.view', 'resource': 'users', 'action': 'view', 'description': 'View user list and details'},
        ...
        {'id': 5, 'name': 'View Roles', 'slug': 'roles.view', 'resource': 'roles', 'action': 'view', 'description': 'View role list and details'},
        ...
        {'id': 9, 'name': 'View Permissions', 'slug': 'permissions.view', 'resource': 'permissions', 'action': 'view', 'description': 'View permission list'},
        ...
        {'id': 11, 'name': 'View Institution', 'slug': 'institution.view', 'resource': 'institution', 'action': 'view', 'description': 'View institution details'},
        ...
        {'id': 13, 'name': 'View Subscriptions', 'slug': 'subscriptions.view', 'resource': 'subscriptions', 'action': 'view', 'description': 'View subscription details'},
        ...
        {'id': 15, 'name': 'View Audit Logs', 'slug': 'audit_logs.view', 'resource': 'audit_logs', 'action': 'view', 'description': 'View audit logs'},
        {'id': 16, 'name': 'View Dashboard', 'slug': 'dashboard.view', 'resource': 'dashboard', 'action': 'view', 'description': 'Access dashboard'},
        {'id': 17, 'name': 'View Reports', 'slug': 'reports.view', 'resource': 'reports', 'action': 'view', 'description': 'View reports'},
