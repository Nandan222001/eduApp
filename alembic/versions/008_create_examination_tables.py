...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('exam_type', sa.Enum('unit', 'mid_term', 'final', 'mock'), nullable=False),
        sa.Column('description', sa.Text(), nullable=True),
        sa.Column('start_date', sa.Date(), nullable=False),
        sa.Column('end_date', sa.Date(), nullable=False),
        sa.Column('status', sa.Enum('scheduled', 'ongoing', 'completed', 'cancelled'), nullable=False, server_default='scheduled'),
