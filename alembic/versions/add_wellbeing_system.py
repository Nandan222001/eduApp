...
def upgrade() -> None:
    ...
    sa.Column('detected_indicators', postgresql.JSON(astext_type=sa.Text()), nullable=False),
    ...
    sa.Column('distress_indicators', postgresql.JSON(astext_type=sa.Text()), nullable=True),
    sa.Column('detected_keywords', postgresql.JSON(astext_type=sa.Text()), nullable=True),
    ...
    sa.Column('baseline_metrics', postgresql.JSON(astext_type=sa.Text()), nullable=False),
    sa.Column('current_metrics', postgresql.JSON(astext_type=sa.Text()), nullable=False),
    ...
    sa.Column('consent_details', postgresql.JSON(astext_type=sa.Text()), nullable=True),
