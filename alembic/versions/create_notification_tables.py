...
def upgrade() -> None:
    ...
    op.create_table('notification_preferences',
        ...
        sa.Column('in_app_types', sa.JSON(), nullable=True),
        sa.Column('group_preferences', sa.JSON(), nullable=True),
        ...
        sa.Column('quiet_hours_days', sa.JSON(), nullable=True),
        sa.Column('digest_mode', sa.String(length=20), nullable=False, server_default='disabled'),
        sa.Column('digest_channels', sa.JSON(), nullable=True),
